...
;
	...
	private function _executeNumericBinaryOperation($cellID, $operand1, $operand2, $operation, $matrixFunction, &$stack) {
		...
		if ($executeMatrixOperation) {
			...
			if ((PHPExcel_Calculation_Functions::getCompatibilityMode () != PHPExcel_Calculation_Functions::COMPATIBILITY_OPENOFFICE) && ((is_string ( $operand1 ) && ! is_numeric ( $operand1 )) || (is_string ( $operand2 ) && ! is_numeric ( $operand2 )))) {

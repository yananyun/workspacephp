...
class PHPExcel_Calculation_Database {
	 ...
	 *        	the column label in which you specify a condition for the
	 *        	column.
	 * @return integer @TODO The field argument is optional. If field is omitted, DCOUNT counts all records in the
	 ...
	 *        	the column label in which you specify a condition for the
	 *        	column.
	 * @return integer @TODO The field argument is optional. If field is omitted, DCOUNTA counts all records in the
	 *         database that match the criteria.
	 *        
	 */

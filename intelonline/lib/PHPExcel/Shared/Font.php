...
class PHPExcel_Shared_Font {
	...
	/**
	 * Set the path to the folder containing .
	 * ttf files. There should be a trailing slash.
	 ...
	 *        	Font object
	 * @param PHPExcel_RichText|string $cellText
	 *        	Text to calculate width
	 * @param integer $rotation
	 *        	Rotation angle
	 * @param PHPExcel_Style_Font|NULL $defaultFont
	 *        	Font object

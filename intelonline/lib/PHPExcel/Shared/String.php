...
;
	 ...
	 * If it has not yet been set explicitly, try to obtain number
	 ...
	 * Only used by PHPExcel_Style_NumberFormat::toFormattedString()
	 ...
	 * If it has not yet been set explicitly, try to obtain the

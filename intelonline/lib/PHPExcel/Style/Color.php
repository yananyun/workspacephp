...
class PHPExcel_Style_Color extends PHPExcel_Style_Supervisor implements PHPExcel_IComparable {
	 ...
	 * @param boolean $hex
	 *        	Flag indicating whether the component should be returned as a hex or a
	 *        	decimal value
	 ...
	 *        	Flag to indicate whether default background or foreground colour

...
class PHPExcel_Writer_Excel2007_Style extends PHPExcel_Writer_Excel2007_WriterPart {
	 ...
	 *        	XML Writer
	 * @param PHPExcel_Style_Fill $pFill
	 *        	Fill style
	 * @throws PHPExcel_Writer_Exception
	 */
	 ...
	 * @param PHPExcel_Shared_XMLWriter $objWriter
	 *        	XML Writer
	 * @param PHPExcel_Style_Font $pFont
	 *        	Font style
	 * @throws PHPExcel_Writer_Exception
	 */
	 ...
	 * @param PHPExcel_Shared_XMLWriter $objWriter
	 *        	XML Writer
	 * @param PHPExcel_Style_Borders $pBorders
	 *        	Borders style
	 * @throws PHPExcel_Writer_Exception
	 */
	 ...
	 * @param string $pName
	 *        	Element name
	 * @param PHPExcel_Style_Border $pBorder
	 *        	Border style
	 * @throws PHPExcel_Writer_Exception
	 */
	 ...
	 * @param PHPExcel_Shared_XMLWriter $objWriter
	 *        	XML Writer
	 * @param PHPExcel_Style_NumberFormat $pNumberFormat
	 *        	Number Format
	 * @param int $pId

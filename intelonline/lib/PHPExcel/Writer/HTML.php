...
class PHPExcel_Writer_HTML extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter {
	 ...
	 * Generate CSS styles
	 *
	 * @param boolean $generateSurroundingHTML
	 ...
	 *
	 * @param PHPExcel_Style_Alignment $pStyle
	 ...
	 *
	 * @param PHPExcel_Style_Font $pStyle
	 *        	PHPExcel_Style_Font
	 * @return array
	 */
	 ...
	 *
	 * @param PHPExcel_Style_Borders $pStyle
	 ...
	 *
	 * @param PHPExcel_Style_Border $pStyle
	 ...
	 *
	 * @param PHPExcel_Style_Fill $pStyle
	 *        	PHPExcel_Style_Fill
	 * @return array
	 */

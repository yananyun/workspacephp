...
class PHPExcel_Calculation_Financial {
	 ...
	 * @param
	 *        	mixed maturity The security's maturity date.
	 *        	The maturity date is the date when the security expires.
	 * @param
	 *        	mixed frequency the number of coupon payments per year.
	 *        	Valid frequency values are:
	 *        	1 Annual
	 *        	2 Semi-Annual
	 *        	4 Quarterly
	 ...
	 * @param
	 *        	float salvage Value at the end of the depreciation.
	 *        	(Sometimes called the salvage value of the asset)
	 * @param
	 *        	integer life Number of periods over which the asset is depreciated.
	 *        	(Sometimes called the useful life of the asset)
	 * @param
	 *        	integer period The period for which you want to calculate the
	 *        	depreciation. Period must use the same units as life.
	 * @param
	 *        	integer month Number of months in the first year. If month is omitted,
	 *        	it defaults to 12.
	 * @return float
	 */
	 ...
	 *        	depreciation. Period must use the same units as life.
	 * @param
	 *        	float factor The rate at which the balance declines.
	 ...
	 * @param
	 *        	int basis The type of day count to use.
	 *        	0 or omitted US (NASD) 30/360
	 *        	1 Actual/actual
	 *        	2 Actual/360
	 *        	3 Actual/365
	 ...
	 * @param
	 *        	float pmt The payment made each period and cannot change over the life
	 *        	of the annuity.
	 *        	Typically, pmt includes principal and interest but no other
	 *        	fees or taxes.
	 * @param
	 *        	float pv The present value - the total amount that a series of future
	 *        	payments is worth now.
	 * @param
	 *        	float fv The future value, or a cash balance you want to attain after
	 ...
	 *        	1 At the beginning of the period.
	 * @param
	 *        	float guess Your guess for what the rate will be.
	 ...
	 *
	 * @param
	 *        	mixed settlement The Treasury bill's settlement date.
	 *        	The Treasury bill's settlement date is the date after the issue date when the Treasury bill is traded to the buyer.
	 * @param
	 *        	mixed maturity The Treasury bill's maturity date.

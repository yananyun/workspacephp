...
class PHPExcel_Calculation_LookupRef {
	 ...
	 *        	4 Relative
	 * @param
	 *        	referenceStyle A logical value that specifies the A1 or R1C1 reference style.
	 ...
	 *
	 * @param
	 *        	cellAddress The reference from which you want to base the offset. Reference must refer to a cell or
	 ...
	 * @param
	 *        	cols The number of columns, to the left or right, that you want the upper-left cell of the result
	 ...
	 *        	A matrix of values
	 * @return array Unlike the Excel TRANSPOSE function, which will only work on a single row or column, this function will transpose a full matrix.
	 */

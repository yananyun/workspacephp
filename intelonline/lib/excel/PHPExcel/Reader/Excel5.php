...
class PHPExcel_Reader_Excel5 extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader {
	 ...
	 * Only important for BIFF5 (Excel 5.0 - Excel 95)
	...
	/**
	 * The shared formula parts in a sheet.
	 * One FORMULA record contributes with one value if it
	 ...
	 * In Excel 95 (BIFF7) and earlier versions,
	 ...
	 * This function just stores the binary shared formula in the reader,
	 ...
	 * This record represents a cell range of empty cells.
	 * All
	 ...
	 * Free CONTINUE record may be a camouflaged MSODRAWING record
	 ...
	 * records are found.
	 * Splices the record data pieces and returns the combined string as if record data
	 * is in one piece.
	 ...
	 *
	 * @param string $formulaStructure
	 *        	The complete binary data for the formula
	 * @param string $baseCell
	 ...
	 * Uses positive and negative values for row and column
...
;
	 ...
	 * Used for explicit string tokens in formulas.

...
class PHPExcel_Worksheet implements PHPExcel_IComparable {
	 ...
	 *
	 * @param boolean $calculateMergeCells
	 ...
	 * @param string $updateFormulaCellReferences
	 *        	boolean Flag indicating whether cell references in formulae should
	 ...
	 * @deprecated
	 *
	 * @param PHPExcel_Style $pSharedCellStyle
	 *        	Cell style to share
	 * @param string $pRange
	 ...
	 * Use instead mergeCells() to merge
	 * a single cell range.
	 *
	 * @param
	 *        	array
	 ...
	 *
	 * @param integer $pColumn1
	 *        	Numeric column coordinate of the first cell
	 * @param integer $pRow1
	 *        	Numeric row coordinate of the first cell
	 * @param integer $pColumn2
	 ...
	 * @param boolean $strictNullComparison

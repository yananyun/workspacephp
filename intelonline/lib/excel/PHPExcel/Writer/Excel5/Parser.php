...
class PHPExcel_Writer_Excel5_Parser {
	 ...
	 * (or range).
	 * If it doesn't exist yet add it to the workbook's references
	 ...
	 * indexed row and column number.
	 * Also returns two (0,1) values to indicate
	 ...
	 *        	The formula to parse, without the initial equal
	 *        	sign (=).
	...
	/**
	 * Creates a tree.
	 * In fact an array which may have one or two arrays (sub-trees)
	 * as elements.
	 *
	 * @access private
	 * @param mixed $value

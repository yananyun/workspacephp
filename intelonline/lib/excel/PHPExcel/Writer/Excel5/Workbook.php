...
$rowmin, $rowmax, $colmin, $colmax );
	 ...
	 * @param integer $type
	 *        	Built-in name type
	 * @param integer $rowmin
	 *        	Start row
	 * @param integer $rowmax
	 *        	End row
	 * @param integer $colmin
	 *        	Start colum
	 * @param integer $colmax
	 *        	End column
	 */
	 ...
	 * blocks or whether it starts at the beginning of the block.
	 * (There are also

...
function smarty_function_html_select_time($params, $template) {
	...
	if ($display_meridian && ! $use_24_hours) {
		...
		$_html_meridian .= '<option value="am"' . ($_hour < 12 ? ' selected="selected"' : '') . '>AM</option>' . $option_separator . '<option value="pm"' . ($_hour < 12 ? '' : ' selected="selected"') . '>PM</option>' . $option_separator . '</select>';
	}
